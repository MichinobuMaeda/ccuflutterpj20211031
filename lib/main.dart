...
class FirestoreModel extends ChangeNotifier {
  ...
  Future<void> listen() async {
    ...
    _db.collection('counters').doc('counter01').snapshots().listen(
      (doc) {
        if (doc.exists) {
...
class _MyHomePageState extends State<MyHomePage> {
  // int _counter = 0; --> FireStore から取得する値に差し替え。
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FirestoreModel>(builder: (context, firestoreModel, child) {
      return Scaffold(
        appBar: AppBar(
